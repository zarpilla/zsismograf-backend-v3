let config = {
    ...
    dataSource: {     
        ...
        columns: [ { name: "name", expand: false, caption: 'Nom' } ], // Specify a dimension on columns.
        rows: [ { name: "strategy", expand: false } ], // Specify a dimension on rows.            
        measures: ["Num"],
        schema: {
            model: {
                fields: {
            ...
            cube: {
                dimensions: {
                    ...
                    strategy: { caption: "Estratègies (TOTES)" },
